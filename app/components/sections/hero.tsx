  ...
  return (
    <section className="mt-28">
      <article className="flex gap-x-28">
        <Image className="rounded-3xl hidden sm:block" height={420} src={myself} quality={100} alt="me"/>
      ...
      <footer className="flex justify-between px-6 py-4 rounded-2xl mt-10 bg-gray-100 w-full">
        ...
        <Link href="https://leetcode.com/fi_van/"><Image height={40} src={leetcode} alt='leetcode'/></Link>
        <Link href="https://github.com/fivan999"><Image height={40} src={github} alt='github'/></Link>
        <Link href="https://codeforces.com/profile/fi_van"><Image height={40} src={codeforces} alt='codeforces'/></Link>
      </footer>
    </section>
  )
}
