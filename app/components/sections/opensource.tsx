      ...
      <article className="mt-3 flex flex-wrap-reverse gap-5 flex-row">
        <aside className="flex-shrink py-7 flex-grow min-w-72 jetbrains flex flex-col gap-y-4 text-2xl basis-2/3">
          <p>
            ...
            софт для удобства студентов. С <span className="text-red-300">28.09.2024</span> я числюсь в этой организации и уже успел:
          </p>
          <OpenSourceScroller />
        </aside>
        <Link
          ...
          className="flex-shrink-0 flex-grow-0 m-auto"
          target="_blank"
        >
          <Image
